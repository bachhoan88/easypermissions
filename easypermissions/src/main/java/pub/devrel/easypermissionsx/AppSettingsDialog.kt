...
import pub.devrel.easypermissionsx.AppSettingsDialog.Builder
...
class AppSettingsDialog : Parcelable {
    ...
    private constructor(activityOrFragment: Any,
    ...
    private fun setActivityOrFragment(activityOrFragment: Any) {
        ...
        } else if (activityOrFragment is android.app.Fragment) {
            mContext = activityOrFragment.activity
        } else {
    ...
    private fun startForResult(intent: Intent) {
        ...
        } else if (mActivityOrFragment is android.app.Fragment) {
            (mActivityOrFragment as android.app.Fragment).startActivityForResult(intent,
                    mRequestCode)
        }
    }
     ...
     */
    internal fun showDialog(positiveListener: DialogInterface.OnClickListener,
    ...
    class Builder {
         ...
         * setting [Intent.FLAG_ACTIVITY_NEW_TASK] on
    ...
    companion object {
        ...
        val CREATOR: Parcelable.Creator<AppSettingsDialog> = object : Parcelable.Creator<AppSettingsDialog> {
